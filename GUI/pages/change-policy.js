                    ...
                    <div className="dropdown m-1">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a className="dropdown-item" href="#" 
                                    onClick={() => setPolicyType("PolicyType")}></a></li>
                            <li><a className="dropdown-item" href="#" 
                    ...
                    <div className="row" style={{ display: preds.pred1=="Create new predicate" ? "block" : "none" }}>
                        ...
                        <div className="dropdown m-1">
                            ...
                            <div className="dropdown m-1">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature1((prevState) => ({...prevState, dayOfWeek: "Day Of Week",}))}>
                                        {/* Day Of Week */}
                                    </a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature1((prevState) => ({...prevState, dayOfWeek: "Sunday",}))}>Sunday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature1((prevState) => ({...prevState, dayOfWeek: "Monday",}))}>Monday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature1((prevState) => ({...prevState, dayOfWeek: "Tuesday",}))}>Tuesday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature1((prevState) => ({...prevState, dayOfWeek: "Wednesday",}))}>Wednesday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature1((prevState) => ({...prevState, dayOfWeek: "Thursday",}))}>Thursday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature1((prevState) => ({...prevState, dayOfWeek: "Friday",}))}>Friday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature1((prevState) => ({...prevState, dayOfWeek: "Saturday",}))}>Saturday</a></li>
                                </ul>
                            </div>
                        </div>
                        <div style={{ display: policyType=="Hour Of Day" ? "block" : "none" }}>
                            ...
                            <br/>
                            <div className="input-group mb-3">
                                <span className="input-group-text" id="basic-addon1">Start Hour</span>
                                <input 
                                    type="text" 
                                    className="form-control" 
                            ...
                            <div className="input-group mb-3">
                                <span className="input-group-text" id="basic-addon1">End Hour</span>
                                <input 
                                    type="text" 
                                    className="form-control" 
                                    placeholder="Enter hour (Format- <hh:mm>)" 
                    ...
                    <div className="row" style={{ display: preds.pred2=="Create new predicate" ? "block" : "none" }}>
                        ...
                        <div style={{ display: policyType=="Day Of Month" ? "block" : "none" }}>
                            ...
                            <div className="dropdown m-1">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "Day Of Month",}))}>
                                        {/* Day Of Month */}
                                    </a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "1",}))}>1</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "2",}))}>2</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "3",}))}>3</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "4",}))}>4</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "5",}))}>5</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "6",}))}>6</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "7",}))}>7</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "8",}))}>8</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "9",}))}>9</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "10",}))}>10</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "11",}))}>11</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "12",}))}>12</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "13",}))}>13</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "14",}))}>14</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "15",}))}>15</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "16",}))}>16</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "17",}))}>17</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "18",}))}>18</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "19",}))}>19</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "20",}))}>20</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "21",}))}>21</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "22",}))}>22</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "23",}))}>23</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "24",}))}>24</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "25",}))}>25</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "26",}))}>26</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "27",}))}>27</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "28",}))}>28</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "29",}))}>29</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "30",}))}>30</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfMonth: "31",}))}>31</a></li>
                                </ul>
                            </div>
                        </div>
                        <div style={{ display: policyType=="Day Of Week" ? "block" : "none" }}>
                        <div className="dropdown m-1">
                            ...
                            <div className="dropdown m-1">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfWeek: "Day Of Week",}))}>
                                        {/* Day Of Week */}
                                    </a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfWeek: "Sunday",}))}>Sunday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfWeek: "Monday",}))}>Monday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfWeek: "Tuesday",}))}>Tuesday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfWeek: "Wednesday",}))}>Wednesday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfWeek: "Thursday",}))}>Thursday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfWeek: "Friday",}))}>Friday</a></li>
                                <li><a className="dropdown-item" href="#" 
                                       onClick={(e) => setPredsFeature2((prevState) => ({...prevState, dayOfWeek: "Saturday",}))}>Saturday</a></li>
                                </ul>
                            </div>
                        </div>
                        <div style={{ display: policyType=="Hour Of Day" ? "block" : "none" }}>
