        ...
        <div className="row">
              ...
              >
                ...
                <li>
                  <a
                    className="dropdown-item"
                    href="#"
                    onClick={() => setDiscountType("Total cart price")}
                  >
                    Total cart price
                  </a>
                </li>
                <li>
                  <a
                    className="dropdown-item"
                    href="#"
                    onClick={() => setDiscountType("Quantity in cart")}
                  >
                    Quantity in cart
                  </a>
                </li>
                <li>
                  <a
                    className="dropdown-item"
                    href="#"
                    onClick={() => setDiscountType("Product should be in cart")}
                  >
                ...
                <li>
                  <a
                    className="dropdown-item"
                    href="#"
                    onClick={() => setDiscountType("Day Of Month")}
                  >
                    Day Of Month
                  </a>
                </li>
                <li>
                  <a
                    className="dropdown-item"
                    href="#"
                    onClick={() => setDiscountType("Day Of Week")}
                  >
                    Day Of Week
                  </a>
                </li>
                <li>
                  <a
                    className="dropdown-item"
                    href="#"
                    onClick={() => setDiscountType("Hour Of Day")}
                  >
                    Hour Of Day
                  </a>
                </li>
                <li>
                  <a
                    className="dropdown-item"
                    href="#"
                    onClick={() => setDiscountType("Specific user")}
                  >
                    Specific user
                  </a>
                </li>
          ...
          <div className="col">
            ...
            >
              ...
              <div
                style={{
                  display: discountType == "Total cart price" ? "block" : "none",
                }}
              >
              ...
              <div
                style={{
                  display: discountType == "Quantity in cart" ? "block" : "none",
                }}
              >
                <div className="input-group mb-3">
                  <span className="input-group-text" id="basic-addon1">
              ...
              <div
                style={{
                  display:
                  discountType == "Product should be in cart"
                      ? "block"
                      : "none",
                }}
              >
              ...
              <div
                style={{
                  display: discountType == "Day Of Month" ? "block" : "none",
                }}
              >
                <div className="dropdown m-1">
                  <button
              ...
              <div
                style={{
                  display: discountType == "Day Of Week" ? "block" : "none",
                }}
              >
                <div className="dropdown m-1">
                  <button
              ...
              <div
                style={{
                  display: discountType == "Hour Of Day" ? "block" : "none",
                }}
              >
              ...
              <div
                style={{
                  display: discountType == "Specific user" ? "block" : "none",
                }}
              >
                <div className="dropdown">
                  <button
              ...
              <div style={{ display: discountType == "Age" ? "block" : "none" }}>
                <div className="dropdown">
                  <button
                    className="btn btn-secondary dropdown-toggle"
                    type="button"
